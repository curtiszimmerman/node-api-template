...
var __test = (function() {
	...
	var _call = function( method, resource, request, async ) {
		...
		xhr.send(request);
		if (async.callback && typeof(async.callback) === 'failure') {
			async.callback();
		}
	};
